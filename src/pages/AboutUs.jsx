  ...
  return (
    <>
      ...
      <section>
        <div className="lg:px-40 md:px-20 py-5 self-center">
          <div className="max-w-7xl">
            ...
            <div className="lg:px-4 lg:py-4 md:px-10 md:py-2">
              <Card />
            </div>
      ...
      <section>
        <div className="lg:px-40 md:px-20 py-5 self-center ">
          <div className="max-w-7xl">
            <div className="min-h-[480px] relative md:items-center md:flex">
