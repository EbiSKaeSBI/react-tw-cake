    ...
    return (
        ...
        md:px-5  drop-shadow-md">
                ...
                <ul className="flex gap-8 self-center">
                    ...
                    <li className="text-black"><a href="/contacts" className="p-3 py-1 text-sm  font-semibold hover:bg-gray-700 hover:text-white rounded-md transition-all">Контакты</a></li>
