        ...
        <>
            <header className="flex justify-between items-center text-black py-6 px-8 md:px-5 drop-shadow-md">
                ...
                <ul className="flex gap-8 self-center">
                    <li className="text-black"><a href="/" className="p-3 py-1 lg:text-sm font-semibold hover:bg-gray-700 hover:text-white rounded-md transition-all sm:text-xs">Главная</a></li>
                    <li className="text-black"><a href="/about" className="p-3 py-1 lg:text-sm font-semibold hover:bg-gray-700 hover:text-white rounded-md transition-all sm:text-xs">О нас</a></li>
                    <li className="text-black"><a href="/catalog" className="p-3 py-1 lg:text-sm font-semibold hover:bg-gray-700 hover:text-white rounded-md transition-all sm:text-xs">Каталог</a></li>
                    <li className="text-black"><a href="/contacts" className="p-3 py-1 lg:text-sm font-semibold hover:bg-gray-700 hover:text-white rounded-md transition-all sm:text-xs">Контакты</a></li>
